...
# 📖 [Debt Manager] <a name="about-project"></a>
...
- [Live Demo Link](https://debt-manager.fly.dev/)
...
Feel free to check the [issues page](https://github.com/Ibnballo1/debt_manager/issues).
...
This project is [MIT](https://github.com/Ibnballo1/debt_manager/blob/readme/MIT.md) licensed.
